...
public class SearchJobFragment extends BaseFragment implements View.OnClickListener {
    ...
    protected void initListener() {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("serachStr", searchList.get(position).toString());
            ...
            public boolean onEditorAction(TextView v, int actionId,
                ...
                if ((actionId == 0 || actionId == 3) && event != null) {
                    ...
                    if(mSearchEdit.getText().length()>0){
                        Intent intent = new Intent(getActivity(), RecruitActivity.class);
                        intent.putExtra("serachStr", mSearchEdit.getText().toString().trim());
                        getActivity().startActivity(intent);

                        mEditor = mSharedPreferences.edit();
                        mEditor.putString("product_history", historyString + mSearchEdit.getText().toString().trim() + ",");
                        mEditor.commit();
                    }else{
    ...
    protected void initData() {
        ...
        historyString = mSharedPreferences.getString("job_history", "");
