...
import com.qgyyzs.globalcosmetics.mvp.ipresenter.ZhongbiaoPresenter;
...
public class BidAFragment extends BaseFragment implements BidView{
    private ZhongbiaoPresenter presenter;
    ...
    protected void initData() {
        ...
        mBidaListAdapter = new BidListAdapter( getActivity(),mBidaBeanList, 1);
        recyclerView.setAdapter(mBidaListAdapter);

        presenter=new ZhongbiaoPresenter(this, (RxFragmentActivity) getActivity());
