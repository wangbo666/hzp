...
import com.qgyyzs.globalcosmetics.nim.contact.constant.UserConstant;
import com.qgyyzs.globalcosmetics.nim.contact.helper.UserUpdateHelper;
import com.qgyyzs.globalcosmetics.nim.main.model.Extras;
...
public class UserProfileSettingActivity extends UI implements View.OnClickListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == PICK_AVATAR_REQUEST) {
            String path = data.getStringExtra(com.qgyyzs.globalcosmetics.uikit.business.session.constant.Extras.EXTRA_FILE_PATH);
            updateAvatar(path);
        }
    }
