package com.qgyyzs.globalcosmetics.nim.jsbridge;
    ...
    private void buildCallingNotification(String msg) {
        if (notification == null) {
            ...
            PendingIntent pendingIntent = PendingIntent.getActivity(context, NOTIFY_ID, localIntent, PendingIntent
                    .FLAG_UPDATE_CURRENT);
            notification = makeNotification(pendingIntent, context.getString(R.string.app_name), msg, msg, R.mipmap.ic_logo, false, false);
        }
    }
