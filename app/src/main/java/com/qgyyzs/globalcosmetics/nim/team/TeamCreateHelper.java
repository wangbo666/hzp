package com.qgyyzs.globalcosmetics.nim.team;
...
public class TeamCreateHelper {
    ...
    public static void createNormalTeam(final Context context, List<String> memberAccounts, final boolean isNeedBack, final RequestCallback<CreateTeamResult> callback) {
        ...
        DialogMaker.showProgressDialog(context, context.getString(com.qgyyzs.globalcosmetics.R.string.empty), true);
        // 创建群
                ...
                new RequestCallback<CreateTeamResult>() {
                    ...
                    public void onSuccess(CreateTeamResult result) {
                        ...
                        if (failedAccounts != null && !failedAccounts.isEmpty()) {
                            ...
                            Toast.makeText(DemoCache.getContext(), com.qgyyzs.globalcosmetics.R.string.create_team_success, Toast.LENGTH_SHORT).show();
                        }
                    ...
                    public void onFailed(int code) {
                        DialogMaker.dismissProgressDialog();
                        if (code == 801) {
                            String tip = context.getString(com.qgyyzs.globalcosmetics.R.string.over_team_member_capacity, DEFAULT_TEAM_CAPACITY);
                            Toast.makeText(DemoCache.getContext(), tip,
                                    Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(DemoCache.getContext(), com.qgyyzs.globalcosmetics.R.string.create_team_failed,
                                    Toast.LENGTH_SHORT).show();
                        }
        ...
        NIMClient.getService(TeamService.class).createTeam(fields, type, "",
                ...
                new RequestCallback<CreateTeamResult>() {
                    ...
                    public void onFailed(int code) {
                        ...
                        String tip;
                        if (code == 801) {
                            tip = context.getString(com.qgyyzs.globalcosmetics.R.string.over_team_member_capacity,
                                    DEFAULT_TEAM_CAPACITY);
                        } else if (code == 806) {
                            tip = context.getString(com.qgyyzs.globalcosmetics.R.string.over_team_capacity);
                        } else {
                            tip = context.getString(com.qgyyzs.globalcosmetics.R.string.create_team_failed) + ", code=" +
                                    code;
                        }
