package com.qgyyzs.globalcosmetics.nim.session;
...
import com.qgyyzs.globalcosmetics.uikit.api.wrapper.NimMessageRevokeObserver;
...
//            p2pCustomization.backgroundUri = "android.resource://com.qgyyzs.globalcosmetics.nim2/drawable/bk"
    ...
    private static void setSessionListener() {
        SessionEventListener listener = new SessionEventListener() {
            ...
            public void onAvatarClicked(Context context, IMMessage message) {
                ...
                LogUtils.e("nimid=" + message.getFromAccount());
                if (message.getFromAccount().indexOf("temp") == -1) {
                    String fuserid = message.getFromAccount().substring(6, message.getFromAccount().length());
