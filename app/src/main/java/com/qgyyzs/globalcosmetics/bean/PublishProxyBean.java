...
public class PublishProxyBean {
    ...
    public class JsonData {
        ...
        public void setIsZhijie(int IsZhijie){
            this.IsZhijie = IsZhijie;
        }
        public int getIsZhijie(){
        ...
        public void setZcFrom(int ZcFrom){
            this.ZcFrom = ZcFrom;
        }
        public int getZcFrom(){
            return this.ZcFrom;
        }
