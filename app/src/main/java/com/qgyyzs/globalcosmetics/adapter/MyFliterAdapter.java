...
public class MyFliterAdapter extends MyBaseAdapter {
    ...
    public MyFliterAdapter(Activity context, List<ProductClassBean> stringList, boolean isMulti) {
    ...
    public void setItemData(int position, Object dataItem, Object viewHolder) {
        ProductClassBean str = (ProductClassBean) dataItem;
        ViewHolder myholder= (ViewHolder) viewHolder;
        if (!str.equals("")) {
            myholder.mItemFliterTv.setText(str.getType1());
        }
