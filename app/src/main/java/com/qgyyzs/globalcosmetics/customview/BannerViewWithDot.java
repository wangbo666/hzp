 ...
 *
 */
public class BannerViewWithDot extends LinearLayout {
	 ...
	 * @param context
	 */
	public BannerViewWithDot(Context context) {
		super(context);
	}
	 ...
	 * @param attrs
	 */
	public BannerViewWithDot(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		mScale = context.getResources().getDisplayMetrics().density;
		LayoutInflater.from(context).inflate(R.layout.view_banner_dot, this);
	 ...
	 */
	public void setImageResources(List<String> infoList,
		...
		for (int i = 0; i < imageCount; i++) {
			...
			if (i == 0) {
				mImageViews[i]
						.setBackgroundResource(R.drawable.middle_icon_trace_selected);
			} else {
				mImageViews[i]
						.setBackgroundResource(R.drawable.middle_icon_trace_default);
			}
				...
				imageView.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						mImageCycleViewListener.onImageClick(
								mAdList.get(position), position, v);
					}
				});
	...
	public static interface ImageCycleViewListener {
		 ...
		 * @param imageView
		 */
		public void onImageClick(String str, int postion, View imageView);
