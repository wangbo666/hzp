...
public class UpdateFriendRemakePresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = UpdateFriendRemakePresenter.class.getSimpleName();

    public UpdateFriendRemakePresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void updateRemake() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getUpdateFriendRemakeApi().Update(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
