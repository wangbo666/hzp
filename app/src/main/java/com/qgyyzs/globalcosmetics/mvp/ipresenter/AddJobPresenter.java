...
public class AddJobPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = AddJobPresenter.class.getSimpleName();

    public AddJobPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void PublishJob() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getPublishJobApi().addJob(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
