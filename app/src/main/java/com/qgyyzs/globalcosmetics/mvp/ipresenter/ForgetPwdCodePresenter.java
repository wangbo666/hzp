...
public class ForgetPwdCodePresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = ForgetPwdCodePresenter.class.getSimpleName();

    public ForgetPwdCodePresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void getCode() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getForgetPwdCodeApi().getCode(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
