...
public class UpdateUserPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = UpdateUserPresenter.class.getSimpleName();

    public UpdateUserPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void updateUser() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getUpdateUserApi().UpdateUser(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
