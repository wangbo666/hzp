...
public class SortProductBigPresenter extends IBasePresenter<SortProductView,RxActivity> {
    private List<ProductClassBean> mProductClassBeenList;
    private int id;
    private String type;
    private final String TAG = SortProductBigPresenter.class.getSimpleName();

    public SortProductBigPresenter(SortProductView view, RxActivity activity) {
        super(view, activity);
    }
