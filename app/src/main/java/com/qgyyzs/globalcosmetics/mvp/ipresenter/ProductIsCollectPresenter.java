...
public class ProductIsCollectPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = ProductIsCollectPresenter.class.getSimpleName();

    public ProductIsCollectPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void isCollect() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getProductIsCollectApi().isCollect(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
    }
}
