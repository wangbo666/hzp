...
public class BindPhoneCodePresenter extends IBasePresenter<StringView,Activity> {
    private String msg="";

    private final String TAG = BindPhoneCodePresenter.class.getSimpleName();

    public BindPhoneCodePresenter(StringView view, Activity activity) {
        super(view, activity);
    }
    ...
    public void BindPhone() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getBindPhoneCodeApi().getCode(AesUtils.AesString(getView().getJsonString()))).subscribe(httpRxObserver);
