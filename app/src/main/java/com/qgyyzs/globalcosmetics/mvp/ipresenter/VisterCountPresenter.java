...
public class VisterCountPresenter extends IBasePresenter<StringView,Activity> {
    private String msg="";

    private final String TAG = VisterCountPresenter.class.getSimpleName();

    public VisterCountPresenter(StringView view, Activity activity) {
        super(view, activity);
    }
    ...
    public void getVisCount() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getVisterCountApi().getCount(AesUtils.AesString(getView().getJsonString()))).subscribe(httpRxObserver);
