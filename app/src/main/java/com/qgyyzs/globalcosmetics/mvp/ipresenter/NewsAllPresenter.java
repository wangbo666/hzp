...
public class NewsAllPresenter extends IBasePresenter<NewsView,RxFragmentActivity> {
    ...
    private final String TAG = NewsAllPresenter.class.getSimpleName();
    public NewsAllPresenter(NewsView view, RxFragmentActivity activity) {
        super(view, activity);
    }
    ...
    public void getNewsList() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getNewsAllApi().getNewsAll(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
