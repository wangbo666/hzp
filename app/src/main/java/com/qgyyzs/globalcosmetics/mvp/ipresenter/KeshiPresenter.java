...
public class KeshiPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = KeshiPresenter.class.getSimpleName();

    public KeshiPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void getKeshi() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getKeshiApi().getKeshi(""), getActivity()).subscribe(httpRxObserver);
