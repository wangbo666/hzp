...
public class ProductCollectPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = ProductCollectPresenter.class.getSimpleName();

    public ProductCollectPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void getCollect() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getProductCollectApi().getCollect(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
