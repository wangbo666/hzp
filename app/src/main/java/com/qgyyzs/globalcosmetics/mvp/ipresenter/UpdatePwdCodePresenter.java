...
public class UpdatePwdCodePresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = UpdatePwdCodePresenter.class.getSimpleName();

    public UpdatePwdCodePresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void getCode() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getUpdatePwdCodeApi().getCode(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
