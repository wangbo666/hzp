...
public class ProductAddAreaPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = ProductAddAreaPresenter.class.getSimpleName();

    public ProductAddAreaPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void addArea() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getProductAreaApi().addArea(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
