...
public class DelProductPresenter extends IBasePresenter<StringView,RxFragmentActivity> {
    private String msg="";

    private final String TAG = DelProductPresenter.class.getSimpleName();

    public DelProductPresenter(StringView view, RxFragmentActivity activity) {
        super(view, activity);
    }
    ...
    public void delProduct() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getDelProductApi().delProduct(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
