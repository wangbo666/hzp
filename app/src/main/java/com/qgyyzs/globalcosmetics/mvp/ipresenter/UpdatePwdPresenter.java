...
public class UpdatePwdPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = UpdatePwdPresenter.class.getSimpleName();

    public UpdatePwdPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void updatePwd() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getUpdatePwdApi().updatePwd(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
