...
public class RegisterPresenter2 extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = RegisterPresenter2.class.getSimpleName();

    public RegisterPresenter2(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void Register() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getRegisterApi2().Register(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
