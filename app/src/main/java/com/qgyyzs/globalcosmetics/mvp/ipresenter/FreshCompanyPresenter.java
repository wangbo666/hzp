...
public class FreshCompanyPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = FreshCompanyPresenter.class.getSimpleName();

    public FreshCompanyPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void getFresh() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getFreshCompanyApi().getFresh(""), getActivity()).subscribe(httpRxObserver);
