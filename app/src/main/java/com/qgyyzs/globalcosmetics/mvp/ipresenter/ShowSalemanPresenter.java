...
public class ShowSalemanPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = ShowSalemanPresenter.class.getSimpleName();

    public ShowSalemanPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void showSaleman() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getiSshowSalemanApi().IsShowsaleman(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
