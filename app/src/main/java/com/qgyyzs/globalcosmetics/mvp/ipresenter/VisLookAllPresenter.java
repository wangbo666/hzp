...
public class VisLookAllPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = VisLookAllPresenter.class.getSimpleName();

    public VisLookAllPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void getLookAll() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getLookVisAllApi().lookAll(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
