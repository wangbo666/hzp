...
public class AddVisterPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = AddVisterPresenter.class.getSimpleName();

    public AddVisterPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void addVister() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getProductVisterAddApi().addVister(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
