...
public class AddFriendPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = AddFriendPresenter.class.getSimpleName();

    public AddFriendPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void addFriend() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getFriendAddApi().addFriend(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
