...
public class IsFabuPresenter extends IBasePresenter<StringView,Activity> {
    private String msg="";

    private final String TAG = IsFabuPresenter.class.getSimpleName();

    public IsFabuPresenter(StringView view, Activity activity) {
        super(view, activity);
    }
    ...
    public void isFabu() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getiSfabuApi().isfabu(AesUtils.AesString(getView().getJsonString()))).subscribe(httpRxObserver);
