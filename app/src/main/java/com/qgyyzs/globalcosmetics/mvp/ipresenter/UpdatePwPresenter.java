...
public class UpdatePwPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = UpdatePwPresenter.class.getSimpleName();

    public UpdatePwPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void updatePw() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getUpdatePWApi().updatePW(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
