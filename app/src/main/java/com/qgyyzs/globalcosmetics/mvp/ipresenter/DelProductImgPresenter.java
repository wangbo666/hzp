...
public class DelProductImgPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = DelProductImgPresenter.class.getSimpleName();

    public DelProductImgPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void delProductImg() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getDelProductImgApi().delImg(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
