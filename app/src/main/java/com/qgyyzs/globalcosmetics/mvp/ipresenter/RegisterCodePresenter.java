...
public class RegisterCodePresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = RegisterCodePresenter.class.getSimpleName();

    public RegisterCodePresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void getCode() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getRegisterCodeApi().registerCode(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
