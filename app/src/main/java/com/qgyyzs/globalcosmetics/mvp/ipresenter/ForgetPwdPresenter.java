...
public class ForgetPwdPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = ForgetPwdPresenter.class.getSimpleName();

    public ForgetPwdPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void replacePwd() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getForgetPwdApi().forgetPwd(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
