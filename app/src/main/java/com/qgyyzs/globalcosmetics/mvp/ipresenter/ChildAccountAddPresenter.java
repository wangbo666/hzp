...
public class ChildAccountAddPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = ChildAccountAddPresenter.class.getSimpleName();

    public ChildAccountAddPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void addChild() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getChildAccountAddApi().addChild(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
