...
public class FriendProductPresenter extends IBasePresenter<ProductListView,RxActivity> {
    private final String TAG = FriendProductPresenter.class.getSimpleName();
    private MyProductBean bean;

    public FriendProductPresenter(ProductListView view, RxActivity activity) {
        super(view, activity);
    }
