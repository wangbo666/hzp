...
public class TypePresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = TypePresenter.class.getSimpleName();

    public TypePresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void getType() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getTypeApi().getType(""), getActivity()).subscribe(httpRxObserver);
