...
public class RegisterSalemanPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = RegisterSalemanPresenter.class.getSimpleName();

    public RegisterSalemanPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void getSaleMan() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getRegisterSalemanApi().getSaleMan(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
