...
public class SetKefuAreaPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = SetKefuAreaPresenter.class.getSimpleName();

    public SetKefuAreaPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void setArea() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getKefuAreaSetApi().setArea(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
