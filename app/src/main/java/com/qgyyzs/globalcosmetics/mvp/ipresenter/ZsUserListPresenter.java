...
public class ZsUserListPresenter extends IBasePresenter<UserListView,RxActivity> {

    private final String TAG = ZsUserListPresenter.class.getSimpleName();

    private UserListBean bean;

    public ZsUserListPresenter(UserListView view, RxActivity activity) {
        super(view, activity);
    }
