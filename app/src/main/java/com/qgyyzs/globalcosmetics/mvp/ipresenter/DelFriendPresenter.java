...
public class DelFriendPresenter extends IBasePresenter<StringView,Activity> {
    private String msg="";

    private final String TAG = DelFriendPresenter.class.getSimpleName();

    public DelFriendPresenter(StringView view, Activity activity) {
        super(view, activity);
    }
    ...
    public void delFriend() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getDelFriendApi().delFriend(AesUtils.AesString(getView().getJsonString()))).subscribe(httpRxObserver);
