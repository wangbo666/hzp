...
public class ChannelPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = ChannelPresenter.class.getSimpleName();

    public ChannelPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void getChannel() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getChannelApi().getChannel(""), getActivity()).subscribe(httpRxObserver);
