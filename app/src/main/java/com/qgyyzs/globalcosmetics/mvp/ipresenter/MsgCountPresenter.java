...
public class MsgCountPresenter extends IBasePresenter<StringView,Activity> {
    private String msg="";

    private final String TAG = MsgCountPresenter.class.getSimpleName();

    public MsgCountPresenter(StringView view, Activity activity) {
        super(view, activity);
    }
    ...
    public void getMsgCount() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getMsgCountApi().getCount(AesUtils.AesString(getView().getJsonString()))).subscribe(httpRxObserver);
    }
}
