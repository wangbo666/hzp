...
public class NewsBidPresenter extends IBasePresenter<NewsView,RxFragmentActivity> {
    ...
    private final String TAG = NewsBidPresenter.class.getSimpleName();
    public NewsBidPresenter(NewsView view, RxFragmentActivity activity) {
        super(view, activity);
    }
    ...
    public void getNewsList() {
            ...
            protected void onSuccess(Object response) {
                ...
                try {
                    ...
                    for (int k = 0; k < array.length(); k++) {
                        ...
                        MedicalNewsBean medicalNewsBean = new MedicalNewsBean(id, title, looknum, res, "");
        ...
        HttpRxObservable.getObservable(ApiUtils.getNewsBidApi().getNewsBid(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
