...
public class RegisterPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = RegisterPresenter.class.getSimpleName();

    public RegisterPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void Register() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getRegisterApi().Register(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
