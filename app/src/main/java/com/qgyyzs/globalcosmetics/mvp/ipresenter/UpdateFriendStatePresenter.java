...
public class UpdateFriendStatePresenter extends IBasePresenter<StringView,Activity> {
    private String msg="";

    private final String TAG = UpdateFriendStatePresenter.class.getSimpleName();

    public UpdateFriendStatePresenter(StringView view, Activity activity) {
        super(view, activity);
    }
    ...
    public void updateState() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getUpdateFriendStateApi().updateState(AesUtils.AesString(getView().getJsonString()))).subscribe(httpRxObserver);
