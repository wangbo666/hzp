...
public class MyProductPresenter extends IBasePresenter<ProductListView,RxFragmentActivity> {
    private final String TAG = MyProductPresenter.class.getSimpleName();

    private MyProductBean bean;

    public MyProductPresenter(ProductListView view, RxFragmentActivity activity) {
        super(view, activity);
    }
    ...
    public void getProductList() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getMyProductApi().getProductList(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
