...
public class JobPresenter extends IBasePresenter<JobView,RxActivity> {
    private final String TAG = JobPresenter.class.getSimpleName();

    private RecruitBean bean;

    public JobPresenter(JobView view, RxActivity activity) {
        super(view, activity);
    }
