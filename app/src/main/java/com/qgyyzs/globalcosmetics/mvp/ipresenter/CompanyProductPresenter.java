...
public class CompanyProductPresenter extends IBasePresenter<ProductListView,RxFragmentActivity> {
    private final String TAG = CompanyProductPresenter.class.getSimpleName();
    private MyProductBean bean;

    public CompanyProductPresenter(ProductListView view, RxFragmentActivity activity) {
        super(view, activity);
    }
    ...
    public void getProductList() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getCompanyProductListApi().getProductList(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
    }
}
