...
public class FeedBackPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = FeedBackPresenter.class.getSimpleName();

    public FeedBackPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void feedBack() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getFeedBackApi().feedBack(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
