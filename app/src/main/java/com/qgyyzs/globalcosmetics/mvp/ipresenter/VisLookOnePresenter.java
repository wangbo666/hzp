...
public class VisLookOnePresenter extends IBasePresenter<StringView,Activity> {
    private String msg="";

    private final String TAG = VisLookOnePresenter.class.getSimpleName();

    public VisLookOnePresenter(StringView view, Activity activity) {
        super(view, activity);
    }
    ...
    public void getLookOne() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getLookVisOneApi().lookOne(AesUtils.AesString(getView().getJsonString()))).subscribe(httpRxObserver);
