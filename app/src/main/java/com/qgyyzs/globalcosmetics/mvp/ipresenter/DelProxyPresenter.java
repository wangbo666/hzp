...
public class DelProxyPresenter extends IBasePresenter<StringView,RxFragmentActivity> {
    private String msg="";

    private final String TAG = DelProxyPresenter.class.getSimpleName();

    public DelProxyPresenter(StringView view, RxFragmentActivity activity) {
        super(view, activity);
    }
    ...
    public void delProduct() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getDelProxyApi().delProxy(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
