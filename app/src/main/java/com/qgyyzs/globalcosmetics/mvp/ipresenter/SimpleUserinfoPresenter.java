...
public class SimpleUserinfoPresenter extends IBasePresenter<UserInfoView,RxActivity> {
    private final String TAG = SimpleUserinfoPresenter.class.getSimpleName();

    private UserinfoBean bean;

    public SimpleUserinfoPresenter(UserInfoView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void getUserInfo() {
        ...
        HttpRxObservable.getObservable(ApiUtils.getSimpleUserInfoApi().getUserInfo(AesUtils.AesString(getView().getJsonString())), getActivity()).subscribe(httpRxObserver);
