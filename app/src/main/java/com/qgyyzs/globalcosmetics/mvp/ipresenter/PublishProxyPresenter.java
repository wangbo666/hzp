...
public class PublishProxyPresenter extends IBasePresenter<PublishProxyView,RxActivity> {
    private final String TAG = PublishProxyPresenter.class.getSimpleName();

    private PublishProxyBean bean;

    public PublishProxyPresenter(PublishProxyView view, RxActivity activity) {
        super(view, activity);
    }
