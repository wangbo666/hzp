...
public class UpdateZizhiImgPresenter extends IBasePresenter<StringView,RxActivity> {
    private String msg="";

    private final String TAG = UpdateZizhiImgPresenter.class.getSimpleName();

    public UpdateZizhiImgPresenter(StringView view, RxActivity activity) {
        super(view, activity);
    }
    ...
    public void updateImg(List<MultipartBody.Part> partList) {
        ...
        HttpRxObservable.getObservable(ApiUtils.getUpdateZizhiImgApi().updateImg(partList), getActivity()).subscribe(httpRxObserver);
