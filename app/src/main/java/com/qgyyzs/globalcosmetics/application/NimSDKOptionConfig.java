...
import com.qgyyzs.globalcosmetics.uikit.api.wrapper.MessageRevokeTip;
import com.qgyyzs.globalcosmetics.uikit.api.wrapper.NimUserInfoProvider;
...
//        options.messageNotifierCustomization = messageNotifierCustomization;
    ...
    private static void initStatusBarNotificationConfig(SDKOptions options) {
        ...
        if (userConfig == null) {
            ...
            userConfig.notificationSmallIconId = R.drawable.ic_logo;
        }
        // 持久化生效
    ...
    private static MixPushConfig buildMixPushConfig() {
        ...
        // 小米推送
        config.xmAppId = "2882303761517611302";
        config.xmAppKey = "5931761139302";
        ...
        // 魅族推送
        config.mzAppId = "1001254";
        config.mzAppKey = "d8476921c4324cc38f4e67555ee8962e";
