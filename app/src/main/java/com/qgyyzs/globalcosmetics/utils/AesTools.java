...
/**
 * Created by tristan on 16/1/27.
 */

public class AesTools {

    private final static String PRE = "~1Ba";
    private final static String Key="Aw8#0zDL#l78$s2G";
    private final static String IV="0754673829576238";
    /**
     *
     * @param json
     * @return 加密后的byte[]
     */
    public static byte[] aesEn(String json) {
