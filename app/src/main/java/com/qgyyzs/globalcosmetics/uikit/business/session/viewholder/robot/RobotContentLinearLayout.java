package com.qgyyzs.globalcosmetics.uikit.business.session.viewholder.robot;
...
import com.qgyyzs.globalcosmetics.uikit.business.robot.model.RobotBotContent;
import com.qgyyzs.globalcosmetics.uikit.business.robot.model.RobotResponseContent;
import com.qgyyzs.globalcosmetics.uikit.business.robot.parser.elements.base.Element;
import com.qgyyzs.globalcosmetics.uikit.business.robot.parser.elements.element.ImageElement;
import com.qgyyzs.globalcosmetics.uikit.business.robot.parser.elements.element.TextElement;
import com.qgyyzs.globalcosmetics.uikit.business.robot.parser.elements.group.LinkElement;
import com.qgyyzs.globalcosmetics.uikit.business.robot.parser.elements.group.TemplateRoot;
...
public class RobotContentLinearLayout extends LinearLayout {
    ...
    private void convertTemplateToViews(final TemplateRoot template, final ClickableChildView robot) {
        List<com.qgyyzs.globalcosmetics.uikit.business.robot.parser.elements.group.LinearLayout> robotLinearLayouts = template.getElements();
        if (robotLinearLayouts == null) {
            return;
        }
        for (com.qgyyzs.globalcosmetics.uikit.business.robot.parser.elements.group.LinearLayout robotLinearLayout : robotLinearLayouts) {
