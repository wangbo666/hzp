package com.qgyyzs.globalcosmetics.uikit.common.util.media;
...
public class ImageUtil {
    ...
    public static Boolean scaleImage(File srcFile, File dstFile, int dstMaxWH, CompressFormat compressFormat, int quality) {
        ...
        try {
            ...
            float rotate;
            String mimeType = com.qgyyzs.globalcosmetics.uikit.common.media.picker.util.BitmapUtil.getImageType(srcFile.getAbsolutePath());
