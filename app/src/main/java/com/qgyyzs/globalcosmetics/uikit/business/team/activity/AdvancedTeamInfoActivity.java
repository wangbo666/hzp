package com.qgyyzs.globalcosmetics.uikit.business.team.activity;
...
import com.qgyyzs.globalcosmetics.uikit.business.contact.core.item.ContactIdFilter;
import com.qgyyzs.globalcosmetics.uikit.business.contact.selector.activity.ContactSelectActivity;
import com.qgyyzs.globalcosmetics.uikit.business.session.actions.PickImageAction;
import com.qgyyzs.globalcosmetics.uikit.business.session.constant.Extras;
import com.qgyyzs.globalcosmetics.uikit.business.team.adapter.TeamMemberAdapter;
import com.qgyyzs.globalcosmetics.uikit.business.team.helper.AnnouncementHelper;
import com.qgyyzs.globalcosmetics.uikit.business.team.helper.TeamHelper;
import com.qgyyzs.globalcosmetics.uikit.business.team.model.Announcement;
import com.qgyyzs.globalcosmetics.uikit.business.team.ui.TeamInfoGridView;
import com.qgyyzs.globalcosmetics.uikit.business.team.viewholder.TeamMemberHolder;
...
import com.qgyyzs.globalcosmetics.uikit.common.media.picker.PickImageHelper;
import com.qgyyzs.globalcosmetics.uikit.common.ui.dialog.DialogMaker;
import com.qgyyzs.globalcosmetics.uikit.common.ui.dialog.MenuDialog;
            ...
            public void onSuccess(List<String> failedAccounts) {
                if (failedAccounts == null || failedAccounts.isEmpty()) {
                    ...
                    for (int i = 0; i < failedAccounts.size(); i++) {
                        membersString += failedAccounts.get(i) + ",";
                    }
...
//        AdvancedTeamMemberInfoActivity.startActivityForResult(AdvancedTeamInfoActivity.this, account, teamId);
    ...
    public String getJoinJsonString() {
        ...
        try {
            ...
            jsonObject.put("joinmembers", membersString);
    ...
    public String getOutJsonString() {
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("tid", teamId);
            jsonObject.put("outmembers", NimUIKit.getAccount());
            LogUtils.e(jsonObject.toString());
        } catch (JSONException e) {
            e.printStackTrace();
        }
    ...
    public String getRemoveJsonString() {
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("tid", teamId);
        } catch (JSONException e) {
